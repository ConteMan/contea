      ...
      <a-collapse-panel key="2" header="V2EX" :style="customStyle">
        <div class="flex  border-l-2 border-blue-gray-300 hover:(border-l-red-600)">
          <div class="flex-grow-1">
            <span class="ml-4 min-w-24">
              开启
            </span>
          </div>
          <div class="flex-grow flex flex-row-reverse text-right">
        ...
        <div class="flex border-l-2 border-l-gray-300 mt-2 hover:(border-l-red-600)">
          ...
          <div class="flex-grow flex flex-row-reverse text-right pl-4">
        ...
        <div class="flex border-l-2 border-l-gray-300 mt-2 hover:(border-l-red-600)">
          ...
          <div class="flex-grow-1 flex flex-row-reverse text-right">
