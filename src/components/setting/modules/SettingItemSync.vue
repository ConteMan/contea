<template>
  ...
  >
    ...
    <n-form-item label="接口地址" path="remoteUrl">
      <n-input v-model:value="model.remoteUrl" placeholder="Url" />
    </n-form-item>

    <n-form-item label="接口端口" path="remotePort">
      <n-input v-model:value="model.remotePort" placeholder="Port" />
    </n-form-item>
...
import type { ShowConfig } from '@services/sync/model'
const module = 'sync'
